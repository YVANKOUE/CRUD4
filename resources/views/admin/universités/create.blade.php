                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form method="post"  action="{{ route('school.create')}}" class="steps-validation wizard-circle">
                                            @csrf
                                            @method('GET')
                                            <!-- Step 1 -->
                                                <section id="step1">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="">
                                                                    <input type="Devenir" class="form-control @error('Devenir') is-invalid @enderror" id="devenir" name="Devenir" placeholder="Devenir" required value="{{ old('Devenir') }}"/>

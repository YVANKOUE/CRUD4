                            ...
                            <div class="row"> 
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input id="localisation" type="text" class="form-control" name="localisation" required autocomplete="">
                                        </div>
                                    </div>
                                </div>   
                            </div> 
                            <div class="row"> 
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input type="description" class="form-control @error('description') is-invalid @enderror" id="udescription" name="description" placeholder="description" value="{{ old('description') }}"/>
                                            @error('description')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
